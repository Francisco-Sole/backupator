...
// // variables
$host = '10.2.232.18';
$nombreDeBaseDeDatos = 'modulocliente2';
$usuario = 'franc';
$pasword = 'capsulecorp';
...
$backup_file = "./" . date("Y-m-d-H-i-s") . ".sql.gz";

$command = "mysqldump --opt -h $host -u $usuario -p$password $nombreDeBaseDeDatos | gzip > archivorespaldo";
 echo date("H:i:s"); 
